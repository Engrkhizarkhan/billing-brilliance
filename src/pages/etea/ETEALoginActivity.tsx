...
const ETEALoginActivity = () => {
  ...
  const { data, loading } = useApiQuery(
    () => api.fetchAuditLogs({ action: 'login', pageSize: 500 }),
    []
  );
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <p className="page-description">Track ETEA portal sign-ins, IPs, and devices.</p>
        </div>
...
export default ETEALoginActivity;
