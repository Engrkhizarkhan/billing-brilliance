...
import { Activity, CreditCard, RefreshCw, TrendingUp } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="page-description">Completed payment events are pushed by the server after a verified posting.</p>
        </div>
        <Button
          variant="outline"
          size="sm"
              ...
              {transactions.map((t) => {
                return (
                  <TableRow key={t.id} className="hover:bg-muted/30">
                    ...
                    <TableCell>
                      <span className="inline-flex items-center rounded-md bg-muted px-2 py-0.5 text-[11px] font-medium text-muted-foreground">Verified</span>
                    </TableCell>
                  </TableRow>
                );
              })}
