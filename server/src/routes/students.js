...
router.post('/', authorizeSchoolRole('admin'), requireLiveTenant, createStudentValidation, handleValidation, studentController.createStudent);
...
router.post('/:id/additional-charge', authorizeSchoolRole('admin', 'finance'), idParam, handleValidation, studentController.createAdditionalCharge);
