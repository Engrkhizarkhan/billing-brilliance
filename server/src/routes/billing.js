...
const { authenticateOrApiKey, tenantScope, requireLiveTenant } = require('../middleware/auth');
...
const { verifiedPostingOnly } = require('../services/integrationPolicy');
// Bill payment write — require school admin or finance role when called by an internal user
router.post('/payment', authenticateOrApiKey, tenantScope, requireLiveTenant, verifiedPostingOnly, billPaymentValidation, handleValidation, billingController.postBillPayment);
