...
-- Engine:  InnoDB
-- =============================================================================
-- Run with:  node server/src/db/migrate.js
-- Fresh run: node server/src/db/migrate.js --fresh
-- =============================================================================
...
-- =============================================================================
-- 1. TENANTS
-- Multi-tenant root.  type = school | org | private_agency
-- api_key: per-tenant key for external integrations (1BILL, SaaS gateway)
-- =============================================================================
...
-- =============================================================================
-- 3. USERS
-- role = admin | school | org
-- school_access_role scopes sub-users within a school tenant
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS students (
  ...
  INDEX idx_students_seq       (tenant_id, seq_number),
...
-- =============================================================================
-- 6. FEE PLANS
-- plan_type = tuition (one per student) | additional (gym, books, etc.)
-- frequency includes 'one-time' for service charges
-- =============================================================================
CREATE TABLE IF NOT EXISTS fee_plans (
  ...
  plan_type  ENUM('tuition','additional') NOT NULL DEFAULT 'tuition',
  created_at TIMESTAMP     DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  deleted_at TIMESTAMP     NULL DEFAULT NULL,
...
-- =============================================================================
-- 8. INVOICES
-- fee_plan_id: links invoice to its source plan (one invoice per plan per month)
-- late_fee: plan's configured late fee captured at generation time
-- late_fee_applied: guards against double-charging
-- =============================================================================
CREATE TABLE IF NOT EXISTS invoices (
  ...
  INDEX idx_invoices_fee_plan (fee_plan_id),
...
-- =============================================================================
-- 10. LEDGER ENTRIES
-- entry_type includes 'late_fee' for styling late charges separately
-- =============================================================================
CREATE TABLE IF NOT EXISTS ledger_entries (
  ...
  entry_type          ENUM('charge','payment','adjustment','late_fee') NOT NULL DEFAULT 'charge',
...
-- =============================================================================
-- 11. PAYMENTS (Bill Payment Records — duplicate-detection anchor)
-- =============================================================================
...
-- =============================================================================
-- 12. ORG POSTINGS
-- Represents entry-test or job-vacancy postings managed by org tenants
-- =============================================================================
...
-- =============================================================================
-- 14. SERVICES  (Org application-level services)
-- =============================================================================
...
-- consumer_number: enables 1LINK BillInquiry / BillPayment lookup
-- =============================================================================
CREATE TABLE IF NOT EXISTS org_payment_records (
  ...
  consumer_number VARCHAR(24)   NULL UNIQUE,
  amount          DECIMAL(15,2) NOT NULL,
  ...
  INDEX idx_org_consumer_number (consumer_number),
  FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- =============================================================================
-- 18. PAYMENT PLAN ASSIGNMENTS
-- assigned_via: 'class' (bulk) or 'individual' (manual)
-- =============================================================================
CREATE TABLE IF NOT EXISTS payment_plan_assignments (
  ...
  assigned_via  ENUM('class','individual')           NOT NULL DEFAULT 'individual',
...
-- =============================================================================
-- 21. SETTINGS  (key-value store per tenant)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS bundles (
  ...
  biller_name VARCHAR(30)   NOT NULL,
...
-- =============================================================================
-- 24. BUNDLE PCIDs  (1LINK per-PCID API keys)
-- biller_id links a PCID to a tenant for SaaS gateway consumer scoping
-- =============================================================================
